...
nuget pack MongoDB.Bson.signed.2.3.0\MongoDB.Bson.signed.nuspec -BasePath MongoDB.Bson.signed.2.3.0
nuget pack MongoDB.Driver.Core.signed.2.3.0\MongoDB.Driver.Core.signed.nuspec -BasePath MongoDB.Driver.Core.signed.2.3.0
nuget pack MongoDB.Driver.signed.2.3.0\MongoDB.Driver.signed.nuspec -BasePath MongoDB.Driver.signed.2.3.0
nuget pack MongoDB.Driver.GridFS.signed.2.3.0\MongoDB.Driver.GridFS.signed.nuspec -BasePath MongoDB.Driver.GridFS.signed.2.3.0
...
nuget add MongoDB.Bson.signed.2.3.0.nupkg -source ..\local-package-source
nuget add MongoDB.Driver.Core.signed.2.3.0.nupkg -source ..\local-package-source
nuget add MongoDB.Driver.signed.2.3.0.nupkg -source ..\local-package-source
nuget add MongoDB.Driver.GridFS.signed.2.3.0.nupkg -source ..\local-package-source