// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ConnectionFactoryMetadata.cs" company="Kephas Software SRL">
...
namespace Kephas.Connectivity
{
    ...
    /// <summary>
    /// The <see cref="IConnectionFactory"/> service metadata.
    /// </summary>
    public class ConnectionFactoryMetadata : AppServiceMetadata
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConnectionFactoryMetadata"/> class.
        /// </summary>
        /// <param name="metadata">The metadata.</param>
        public ConnectionFactoryMetadata(IDictionary<string, object?>? metadata)
            : base(metadata)
        {
            if (metadata == null)
            {
        ...
        public ConnectionFactoryMetadata(string[] connectionKind, Priority processingPriority = 0, Priority overridePriority = 0, string? serviceName = null)
