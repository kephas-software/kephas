...
namespace Kephas.Threading.Tasks
{
    ...
    public class ThreadContextBuilder
    {
        ...
        private static readonly ConcurrentDictionary<string, object> GlobalThreadContextPool = new ();

        private readonly ConcurrentDictionary<string, object> threadContextPool;
        ...
        internal ThreadContextBuilder(ConcurrentDictionary<string, object> threadContextPool)
        {
            threadContextPool = threadContextPool ?? throw new ArgumentNullException(nameof(threadContextPool));
