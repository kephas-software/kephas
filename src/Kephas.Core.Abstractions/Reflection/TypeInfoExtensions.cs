...
namespace Kephas.Reflection
{
    ...
    public static class TypeInfoExtensions
    {
        ...
        {
            typeInfo = typeInfo ?? throw new ArgumentNullException(nameof(typeInfo));
            openGenericTypeInfo = openGenericTypeInfo ?? throw new ArgumentNullException(nameof(openGenericTypeInfo));
            ...
            else if (openGenericTypeInfo.IsInterface)
            {
                ...
                return constructedInterface == null ? null : IntrospectionExtensions.GetTypeInfo(constructedInterface);
            }
