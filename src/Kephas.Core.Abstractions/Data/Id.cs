...
namespace Kephas.Data
{
    ...
    public static class Id
    {
        ...
        {
            if (!TemporaryChecks.Contains(check ?? throw new ArgumentNullException(nameof(check))))
            {
        ...
        {
            return TemporaryChecks.Remove(check ?? throw new ArgumentNullException(nameof(check)));
        }
    }
}