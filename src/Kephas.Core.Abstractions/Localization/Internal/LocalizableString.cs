// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LocalizableString.cs" company="Kephas Software SRL">
...
namespace Kephas.Localization.Internal
{
    ...
    internal class LocalizableString
    {
        ...
        public string Value
        {
            get => this.propertyValue ?? string.Empty;
            set
            {
        ...
        public string GetLocalizableValue()
        {
            ...
            {
                this.cachedResult = () => this.propertyValue ?? string.Empty;
            }
            else
            {
                ...
                {
                    this.cachedResult = () => (string?)property?.GetValue(null, null) ?? string.Empty;
                }
            }
