...
namespace Kephas.Injection.Lite.Builder
{
    ...
    {
        private readonly IServiceProvider ambientServices;
        ...
        public ServiceRegistrationBuilder(IServiceProvider ambientServices, Type contractDeclarationType)
        {
            ...
            switch (this.instancingStrategy)
            {
                ...
                default:
                    if (this.instancingStrategy == null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(string.Format(Strings.ServiceRegistrationBuilder_InstancingNotProvided_Exception, this.contractType, nameof(AppServiceContractAttribute.AllowMultiple), true));
                        }
