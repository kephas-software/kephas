...
namespace Kephas.Injection.Lite.Builder
{
    ...
    public static class ServiceRegistrationBuilderExtensions
    {
        ...
        /// This builder.
        /// </returns>
        public static IRegistrationBuilder ProcessingPriority(this IServiceRegistrationBuilder builder, Priority priority)
        {
            builder = builder ?? throw new ArgumentNullException(nameof(builder));

            return builder.AddMetadata(nameof(IHasProcessingPriority.ProcessingPriority), (int)priority);
        }
        ...
        /// This builder.
        /// </returns>
        public static IRegistrationBuilder OverridePriority(this IServiceRegistrationBuilder builder, Priority priority)
        {
            builder = builder ?? throw new ArgumentNullException(nameof(builder));

            return builder.AddMetadata(nameof(IHasOverridePriority.OverridePriority), (int)priority);
        }
    }
}