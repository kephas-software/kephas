...
namespace Kephas.Injection.Lite.Internal
{
    ...
    internal class ServiceInfo : IServiceInfo, IDisposable
    {
        ...
        public ServiceInfo(IServiceProvider ambientServices, Type contractType, Type instanceType, bool isSingleton)
        {
            this.ContractType = contractType;
        ...
        /// <param name="isSingleton">True if is singleton, false if not.</param>
        public ServiceInfo(IServiceProvider ambientServices, Type contractType, Func<IInjector, object> serviceFactory, bool isSingleton)
        {
            this.ContractType = contractType;
        ...
        /// An IServiceInfo.
        /// </returns>
        public IServiceInfo MakeGenericServiceInfo(IServiceProvider ambientServices, Type[] genericArgs)
        {
        ...
        public AppServiceInfo ToAppServiceInfo(IServiceProvider ambientServices)
        {
        ...
        public object GetService(IServiceProvider ambientServices) => this.lazyFactory.GetValue();
        ...
        private Func<object> GetInstanceResolver(IServiceProvider ambientServices, Type instanceType)
        {
