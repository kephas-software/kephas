...
namespace Kephas.Configuration
{
        ...
        where TSettings : class, new()
    {
        ...
        {
            settingsProviderSelector = settingsProviderSelector ?? throw new ArgumentNullException(nameof(settingsProviderSelector));
            appRuntime = appRuntime ?? throw new ArgumentNullException(nameof(appRuntime));
            lazyEventHub = lazyEventHub ?? throw new ArgumentNullException(nameof(lazyEventHub));
