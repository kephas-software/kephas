...
namespace Kephas.Net.Mime
{
    ...
    public class MediaTypeMetadata : AppServiceMetadata
    {
            ...
            : base(metadata)
        {
            ...
            this.SupportedMediaTypes = (string[]?)metadata.TryGetValue(nameof(this.SupportedMediaTypes)) ?? Array.Empty<string>();
        ...
        {
            this.SupportedMediaTypes = supportedMediaTypes ?? throw new ArgumentNullException(nameof(supportedMediaTypes));
        ...
        /// </value>
        public string[] SupportedMediaTypes { get; } = Array.Empty<string>();
