// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EntityTypeConstructor.cs" company="Kephas Software SRL">
...
namespace Kephas.Data.Model.Runtime.Construction
{
    ...
    public class EntityTypeConstructor : ClassifierConstructorBase<EntityType, IEntityType>
    {
        ...
        {
            return new (constructionContext, this.TryComputeName(runtimeElement, constructionContext)!);
        }
    }
}