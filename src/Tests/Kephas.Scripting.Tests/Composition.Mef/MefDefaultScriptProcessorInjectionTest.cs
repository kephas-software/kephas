// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MefDefaultScriptProcessorInjectionTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Scripting.Tests.Composition.Mef
{
    ...
    [TestFixture]
    public class MefDefaultScriptProcessorInjectionTest : MefScriptingInjectionTestBase
    {
        [Test]
