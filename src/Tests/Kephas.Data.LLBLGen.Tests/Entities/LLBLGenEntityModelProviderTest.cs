// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LLBLGenEntityModelProviderTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Data.LLBLGen.Tests.Entities
{
    ...
    [TestFixture]
    public class LLBLGenEntityModelProviderTest
    {
        [Test]
        public void GetModelTypeInfos_empty()
        {
            var provider =
                new LLBLGenEntityModelProvider(new List<IExportFactory<IEntityFactory, EntityFactoryMetadata>>());
