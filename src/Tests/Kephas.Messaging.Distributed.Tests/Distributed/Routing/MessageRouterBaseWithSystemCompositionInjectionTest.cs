// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MessageRouterBaseWithSystemCompositionInjectionTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Messaging.Tests.Distributed.Routing
{
    ...
    [TestFixture]
    public class MessageRouterBaseWithSystemCompositionInjectionTest : MessagingWithSystemCompositionInjectionTestBase
    {
        [Test]
