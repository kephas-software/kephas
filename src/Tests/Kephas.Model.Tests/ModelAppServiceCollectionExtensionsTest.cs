// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ModelAppServiceCollectionExtensionsTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Model.Tests
{
    ...
    [TestFixture]
    public class ModelAppServiceCollectionExtensionsTest : ModelTestBase
    {
