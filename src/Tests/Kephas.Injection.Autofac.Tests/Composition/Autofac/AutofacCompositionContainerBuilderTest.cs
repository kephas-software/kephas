...
namespace Kephas.Tests.Composition.Autofac
{
    ...
    public class AutofacCompositionContainerBuilderTest : AutofacCompositionTestBase
    {
        ...
        public void CreateContainer_composed_loggers_exported()
        {
            ...
            var logger = container.Resolve<ILogger<AutofacCompositionContainerTest.ExportedClass>>();
        ...
        private AutofacInjectorBuilder CreateCompositionContainerBuilder(Action<IInjectionRegistrationContext> config = null)
        {
        ...
        private AutofacInjectorBuilder CreateCompositionContainerBuilderWithStringLogger()
        {
            var builder = this.CreateCompositionContainerBuilder();
