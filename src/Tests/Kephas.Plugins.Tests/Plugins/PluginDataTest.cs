...
namespace Kephas.Tests.Plugins
{
    ...
    public class PluginDataTest
    {
        ...
        public void Parse_invalid_app_identity_name()
        {
            ...
            Assert.AreEqual("The app ID 'Gigi/Belogea' may not contain '/'. Not allowed characters: ':;,|/\\<>?'\"*@#$^`[]{}'.\r\nParameter name: id", ex.Message);
        }
        ...
        public void Parse_invalid_app_identity_version()
        {
            ...
            Assert.AreEqual("The app version '1.2.3{dev}' may not contain '{'. Not allowed characters: ':;,|/\\<>?'\"*@#$^`[]{}'.\r\nParameter name: version", ex.Message);
        }
