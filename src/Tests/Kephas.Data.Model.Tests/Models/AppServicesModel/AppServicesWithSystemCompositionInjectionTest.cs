// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AppServicesWithSystemCompositionInjectionTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Data.Model.Tests.Models.AppServicesModel
{
    ...
    [TestFixture]
    public class AppServicesWithSystemCompositionInjectionTest : DataModelWithSystemCompositionInjectionTestBase
    {
        [Test]
