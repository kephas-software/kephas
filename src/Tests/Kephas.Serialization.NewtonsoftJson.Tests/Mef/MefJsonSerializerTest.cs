// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MefJsonSerializerTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Serialization.Json.Tests.Mef
{
    ...
    public class MefJsonSerializerTest : MefSerializationTestBase
    {
        [Test]
        public async Task SerializeAsync_Composition()
        {
            ...
            Assert.AreEqual(@"{""$type"":""Kephas.Serialization.Json.Tests.Mef.MefJsonSerializerTest+TestEntity"",""name"":""John Doe"",""personalSite"":""http://site.com/my-site""}", serializedObj);
        }
