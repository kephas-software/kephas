// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SystemCompositionJsonSerializerTest.cs" company="Kephas Software SRL">
...
namespace Kephas.Serialization.Json.Tests.SystemComposition
{
    ...
    public class SystemCompositionJsonSerializerTest : SystemCompositionSerializationTestBase
    {
        [Test]
        public async Task SerializeAsync_injection()
        {
            ...
            Assert.AreEqual(@"{""$type"":""Kephas.Serialization.Json.Tests.SystemComposition.SystemCompositionJsonSerializerTest+TestEntity"",""name"":""John Doe"",""personalSite"":""http://site.com/my-site""}", serializedObj);
        }
