namespace Kephas.Injection
{
    ...
    public static class ExportFactoryExtensions
    {
            ...
            where T : class
        {
            ...
            var exportedValue = exportFactory.CreateExport().Value;
            ServiceHelper.Initialize(exportedValue, context);
            ...
            where T : class
        {
            ...
            var exportedValue = exportFactory.CreateExport().Value;
            await ServiceHelper.InitializeAsync(exportedValue, context, cancellationToken).PreserveThreadContext();
            return exportedValue;
        }
    }
}