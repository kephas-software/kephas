// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ImportManyAttribute.cs" company="Kephas Software SRL">
...
namespace Kephas.Composition.AttributedModel
{
    ...
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ImportManyAttribute"/> class, importing the set of exports without a contract name.
        /// </summary>
        ...
        ///      A <see cref="string"/> containing the contract name of the exports to import, or <see langword="null"/>.
        /// </param>
        ...
        /// </summary>
        /// <value>
        ///      A <see cref="string"/> containing the contract name of the exports to import. The default value is null.
        /// </value>
