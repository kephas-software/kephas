...
namespace Kephas.Injection.ExportFactoryImporters
{
    ...
    public interface ICollectionExportFactoryImporter<TService> : ICollectionExportFactoryImporter
    {
        /// <summary>
        /// Gets the export factories.
        /// </summary>
    ...
    [AppServiceContract(AsOpenGeneric = true)]
    public interface ICollectionExportFactoryImporter<TService, TMetadata> : ICollectionExportFactoryImporter
    {
        /// <summary>
        /// Gets the export factories.
        /// </summary>
