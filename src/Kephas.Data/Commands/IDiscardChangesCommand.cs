...
namespace Kephas.Data.Commands
{
    ...
    public interface IDiscardChangesCommand : IDataCommand<IDiscardChangesContext, IDataCommandResult>, ISyncDataCommand<IDiscardChangesContext, IDataCommandResult>
    {
    }
}