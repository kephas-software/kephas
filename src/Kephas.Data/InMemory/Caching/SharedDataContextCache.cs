// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SharedDataContextCache.cs" company="Kephas Software SRL">
...
namespace Kephas.Data.InMemory.Caching
{
    ...
    public class SharedDataContextCache : DataContextCache
    {
        ...
        public SharedDataContextCache()
            : base(new ConcurrentDictionary<object, IEntityEntry>(), new ConcurrentDictionary<object, IEntityEntry>())
        {
        }
    }
}