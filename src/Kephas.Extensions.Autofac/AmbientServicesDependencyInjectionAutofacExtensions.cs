// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AmbientServicesDependencyInjectionAutofacExtensions.cs" company="Kephas Software SRL">
...
namespace Kephas
{
    ...
    /// </summary>
    public static class AmbientServicesDependencyInjectionAutofacExtensions
    {
        /// <summary>
