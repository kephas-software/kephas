...
namespace Kephas
{
    ...
    public static class AmbientServicesSystemCompositionExtensions
    {
        ...
        public static IAmbientServices BuildWithSystemComposition(this IAmbientServices ambientServices, Action<SystemCompositionInjectorBuilder>? builderOptions = null)
        {
