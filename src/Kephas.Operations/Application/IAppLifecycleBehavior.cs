...
namespace Kephas.Application
{
    ...
    public interface IAppLifecycleBehavior
    {
        ...
        /// </returns>
        Task<IOperationResult> BeforeAppInitializeAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// An asynchronous result yielding the operation result.
        /// </returns>
        Task<IOperationResult> AfterAppInitializeAsync(CancellationToken cancellationToken = default)
        {
            return Task.FromResult((IOperationResult)true.ToOperationResult());
        }
        ...
        /// An asynchronous result yielding the operation result.
        /// </returns>
        Task<IOperationResult> BeforeAppFinalizeAsync(CancellationToken cancellationToken = default)
        {
            return Task.FromResult((IOperationResult)true.ToOperationResult());
        }
        ...
        /// An asynchronous result yielding the operation result.
        /// </returns>
        Task<IOperationResult> AfterAppFinalizeAsync(CancellationToken cancellationToken = default)
        {
            return Task.FromResult((IOperationResult)true.ToOperationResult());
        }
    }
