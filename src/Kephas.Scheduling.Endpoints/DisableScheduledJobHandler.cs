...
namespace Kephas.Scheduling.Endpoints
{
    ...
    /// </summary>
    public class DisableScheduledJobHandler : IMessageHandler<DisableScheduledJobMessage, Response>
    {
        ...
        public async Task<Response> ProcessAsync(DisableScheduledJobMessage message, IMessagingContext context, CancellationToken token)
        {
