...
nuget pack ..\Kephas.Web.ServiceStack\Package.nuspec -BasePath ..\Kephas.Web.ServiceStack -Symbols -properties Configuration=%BuildConfiguration%;Version=%PackageVersion%;RefVersion=%PackageRefVersion%
