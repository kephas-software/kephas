...
namespace Kephas.AspNetCore.Configuration
{
    ...
    /// <summary>
    /// An ASP net configuration store.
    /// </summary>
    public class AspNetConfigurationStore : IConfigurationStore
    {
        /// <summary>
        /// The configuration.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AspNetConfigurationStore"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        public AspNetConfigurationStore(IConfiguration configuration)
        {
