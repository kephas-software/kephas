// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EnabledServiceFactoryCollection.cs" company="Kephas Software SRL">
...
namespace Kephas.Services.Behaviors
{
    ...
    public class EnabledServiceFactoryCollection<TContract, TMetadata> : EnabledServiceCollectionBase<TContract, TMetadata>, IEnabledServiceFactoryCollection<TContract, TMetadata>
