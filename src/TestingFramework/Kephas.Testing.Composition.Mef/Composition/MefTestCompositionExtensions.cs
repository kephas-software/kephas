...
namespace Kephas.Testing.Composition
{
    ...
    {
        public static SystemInjectionContainer CreateCompositionContainer(this ContainerConfiguration configuration)
        {
            Requires.NotNull(configuration, nameof(configuration));

            return new SystemInjectionContainer(configuration);
        }
    }
}