// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MongoLogEventSubscriber.cs" company="Kephas Software SRL">
...
namespace Kephas.MongoDB.Diagnostics;
...
/// <summary>
/// An <see cref="IEventSubscriber"/> for enabling logging.
/// </summary>
internal class MongoLogEventSubscriber : IEventSubscriber
{
    /// <summary>
    /// The logger prefix.
    /// </summary>
