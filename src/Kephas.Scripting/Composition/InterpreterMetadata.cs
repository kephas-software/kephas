// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterpreterMetadata.cs" company="Quartz Software SRL">
...
namespace Kephas.Scripting.Composition
{
    ...
    /// <summary>
    /// A code interpreter metadata.
    /// </summary>
    public class InterpreterMetadata : AppServiceMetadata
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InterpreterMetadata"/> class.
        /// </summary>
        ...
        public InterpreterMetadata(string language, int processingPriority = 0, int overridePriority = 0, bool optionalService = false, string serviceName = null)
