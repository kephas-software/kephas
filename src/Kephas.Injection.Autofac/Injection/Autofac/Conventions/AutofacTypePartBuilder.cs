// --------------------------------------------------------------------------------------------------------------------
// <copyright file="AutofacTypePartBuilder.cs" company="Kephas Software SRL">
...
namespace Kephas.Injection.Autofac.Conventions
{
    ...
    public class AutofacTypePartBuilder : IAutofacPartBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AutofacTypePartBuilder"/> class.
        /// </summary>
        /// <param name="descriptorBuilder">The descriptor builder.</param>
        internal AutofacTypePartBuilder(ServiceDescriptorBuilder descriptorBuilder)
        {
