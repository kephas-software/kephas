// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IdentityUserStoreServiceBase.cs" company="Kephas Software SRL">
...
namespace Kephas.AspNetCore.IdentityServer4.Stores
{
    ...
    public abstract class IdentityUserStoreServiceBase<TUser> : Loggable, IUserStoreService<TUser>, IUserPasswordStore<TUser>, IUserEmailStore<TUser>, IUserConfirmation<TUser>, IUserLockoutStore<TUser>, IUserPhoneNumberStore<TUser>
