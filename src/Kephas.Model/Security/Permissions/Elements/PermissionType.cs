...
namespace Kephas.Model.Security.Permissions.Elements
{
    using System;
    ...
    public class PermissionType : ClassifierBase<IPermissionType>, IPermissionType
    {
        ...
        protected override void OnCompleteConstruction(IModelConstructionContext constructionContext)
        {
            ...
            this.GrantedPermissions = this.BaseMixins
                ...
                .ToList()
                .AsReadOnly();
            this.RequiredPermissions = this.GetAttributes<Attribute>().OfType<IRequiresPermissionAnnotation>()
                .SelectMany(
        ...
        {
            var grantedAttrs = this.GetAttributes<Attribute>().OfType<IGrantsPermissionAnnotation>().ToList();
