// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IModelConstructionContext.cs" company="Kephas Software SRL">
...
namespace Kephas.Model.Construction
{
    ...
    public interface IModelConstructionContext : IContext
    {
        ...
        /// </summary>
        IRuntimeTypeRegistry RuntimeTypeRegistry => this.ServiceProvider.Resolve<IRuntimeTypeRegistry>();
    }
}